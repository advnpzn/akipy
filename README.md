...
CI integration tests start **TRAWL** as a service on the runner (`http://127.0.0.1:8191`). It speaks the FlareSolverr v2 API and is typically faster on Cloudflare solves than FlareSolverr. Remote public solvers are often unreachable from GitHub Actions (403 from edge WAF).
