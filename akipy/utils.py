...
def request_handler(url: str, method: str, data: Union[dict, None] = None) -> httpx.Response:
    if method == 'GET':
...
async def async_request_handler(url: str, method: str, data: Union[dict, None] = None) -> httpx.Response:
    if method == 'GET':
